...
public class RsvpRepo {
    ...
    public List<RSVP> findAll() {
        List<RSVP> rsvps = new ArrayList<>(null);
    ...
    public Boolean save(RSVP rsvp) {
        int iResult = 0;
        iResult = template.update(insertSQL, rsvp.getFullName(), rsvp.getEmail(),
         rsvp.getPhone(), rsvp.getConfirmationDate(), rsvp.getComment());
